...
## Instructions
1. Download the PDF in the repository named `Playbook for Watson Assistant Metrics Notebook` 
2. Follow the step-by-step instructions using the Jupyter notebook `Watson Assistant Metrics Notebook.ipynb`
